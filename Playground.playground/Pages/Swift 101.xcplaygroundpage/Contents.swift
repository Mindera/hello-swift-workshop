/*:
 ...
 Credits:
 - [The Swift Programming Language (Swift 4.1)](https://itunes.apple.com/pt/book/the-swift-programming-language-swift-4-1/id881256329?l=en&mt=11)
 ...
 *Bonus*: Create an implicit constant `Double` with the value `2π` ✨
 */
 ...
 ***Exercise:***
 ...
 Use \() to include a floating-point calculation and someone’s name in a string.
 */
...
// hearts.rawValue // This is an error because Suit doesn't have a raw backing type.
...
/*:
 ***Exercise:***
 Add a static method to Card that creates a full deck of cards, with one card of each combination of rank and suit
 */
...
challenge("enum confirming to `ExampleProtocol`") {
